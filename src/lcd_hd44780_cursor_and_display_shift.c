...
void lcd_hd44780_cursor_and_display_shift_4bit (uint8_t s_c, uint8_t r_l)
{
  ...
  lcd_hd44780_strobe () ;
  s_c ? SETBIT (LCD_HD44780_DATA_PORT, LCD_HD44780_D3) : CLEARBIT (LCD_HD44780_DATA_PORT, LCD_HD44780_D3) ;
  r_l ? SETBIT (LCD_HD44780_DATA_PORT, LCD_HD44780_D2) : CLEARBIT (LCD_HD44780_DATA_PORT, LCD_HD44780_D2) ;
